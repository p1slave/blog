...
## 第七集：新女王Kayla女神（附带8分钟语言羞辱视频）
介绍一位新女王Kayla女神，是模特女神的朋友，参加过群调并且后面偶尔联系，顺便把她的语言羞辱视频做成了一个合集和包括一个擦鞋的视频。

博客链接如下：[https://p1slave.com/2022-06-23-introduce-goddess-kayla/](https://p1slave.com/2022-06-23-introduce-goddess-kayla/)
视频购买链接：[https://jianshou.online/sell/1GDXw0GQ](https://jianshou.online/sell/1GDXw0GQ)

博客的评论系统也改成了自建开源的，之前没发现Disqus评论系统在国内是被墙了，现在可以用了欢迎大家评论。第一次评论需要我审核过才会显示出来，发表评论只需要填写用户名和邮箱就行，邮箱不会显示出来，只是被用来当作唯一ID自动生成一个头像，需要显示自己头像的可以去[Gravatar](https://en.gravatar.com/)上传头像，填写注册[Gravatar](https://en.gravatar.com/)用的邮箱就能在我评论区显示出个性化头像。不过这个头像网站不知道为什么在国内也被墙了，简直莫名其妙。。

另外要加联系方式的朋友可以下载keybase加密聊天，用户名还是p1slave。本人不用微信和QQ，或者推特私信也行（需要翻墙）。

国内的朋友可以下载一个叫OKX的APP尝试使用一下虚拟货币，在国内购买虚拟货币完全合法，要不这个网站和APP早被墙了也不可能上架。未来的论坛还有视频购买会采取虚拟货币支付的手段，目前在内测的论坛可实现USDT支付，但是单笔手续费太高，不是充值1000块钱的话，我都心疼单次6元的手续费，所以还在考虑集成其他支付方式。
